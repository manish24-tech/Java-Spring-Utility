package com.fourbench.authenticationservice.config;

import com.fourbench.authenticationservice.components.AuthEntryPointJwt;
import com.fourbench.authenticationservice.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
	...
	public WebSecurityCustomizer webSecurityCustomizer() {
		return (webSecurity) -> webSecurity.ignoring().requestMatchers ("/", "/h2-console/**",
				"/v3/api-docs/**", "/swagger-ui/**", "/bus/v3/api-docs/**", "/resources/**", "/static/**",
	  ...
	  public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
			...
			// ALLOW ALL HEALTH END-POINT
					.and().authorizeHttpRequests(authz -> authz
							...
							.requestMatchers("/api/v1/codes/**").permitAll()
